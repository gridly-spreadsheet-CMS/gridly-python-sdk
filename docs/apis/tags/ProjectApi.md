<a name="__pageTop"></a>
# gridly.apis.tags.project_api.ProjectApi

All URIs are relative to *https://api.gridly.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**call_list**](#call_list) | **get** /v1/projects | list
[**create**](#create) | **post** /v1/projects | create
[**delete**](#delete) | **delete** /v1/projects/{projectId} | delete
[**find_one**](#find_one) | **get** /v1/projects/{projectId} | findOne
[**update**](#update) | **put** /v1/projects/{projectId} | update
...
```python
import gridly
from gridly.apis.tags import project_api
...
with gridly.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ProjectApi->call_list: %s\n" % e)
```
### Parameters
...
with gridly.ApiClient(configuration) as api_client:
    ...
    try:
        # findOne
        api_response = api_instance.find_one(
            path_params=path_params,
        )
        pprint(api_response)
    except gridly.ApiException as e:
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#find_one.ApiResponseFor200) | OK
...
# **update**
<a name="update"></a>
> Project update(project_idupdate_project)
