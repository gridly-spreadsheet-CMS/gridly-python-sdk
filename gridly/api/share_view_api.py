...
class ShareViewApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_endpoint = _Endpoint(
            settings={
                'response_type': (ShareView,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/v1/views/{viewId}/shares',
                'operation_id': 'create',
                'http_method': 'PUT',
                'servers': None,
            },
    ...
    def create(
        ...
        **kwargs
        ...
        >>> thread = api.create(view_id, create_share_view, async_req=True)
        >>> result = thread.get()
