...
# body param
SchemaForRequestBodyApplicationJson = DeleteDependency


request_body_delete_dependency = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _delete_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_delete_dependency.serialize(body, content_type)
