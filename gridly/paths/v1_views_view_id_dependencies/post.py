...
# body param
SchemaForRequestBodyApplicationJson = CreateDependency


request_body_create_dependency = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Dependency
...
class BaseApi(api_client.Api):
    ...
    def _create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_dependency.serialize(body, content_type)
