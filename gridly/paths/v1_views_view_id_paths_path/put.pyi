...
# body param
SchemaForRequestBodyApplicationJson = UpdatePath


request_body_update_path = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PathSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_path.serialize(body, content_type)
