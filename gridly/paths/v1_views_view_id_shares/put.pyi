...
# body param
SchemaForRequestBodyApplicationJson = CreateShareView


request_body_create_share_view = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ShareView
...
class BaseApi(api_client.Api):
    ...
    def _create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_share_view.serialize(body, content_type)
