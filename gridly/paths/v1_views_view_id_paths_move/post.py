...
# body param
SchemaForRequestBodyApplicationJson = MovePath


request_body_move_path = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _move_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_move_path.serialize(body, content_type)
