...
# body param
SchemaForRequestBodyApplicationJson = UpdateColumn


request_body_update_column = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ViewColumn
...
class BaseApi(api_client.Api):
    ...
    def _update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_column.serialize(body, content_type)
