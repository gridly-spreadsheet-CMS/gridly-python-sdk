...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'importOption': typing.Union[ImportOptionSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
    },
    total=False
)
...
request_query_import_option = api_client.QueryParameter(
    name="importOption",
    style=api_client.ParameterStyle.FORM,
    schema=ImportOptionSchema,
    explode=True,
)
# Path params
