...
# Query params
RootPathSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'rootPath': typing.Union[RootPathSchema, str, ],
    },
    total=False
)
...
request_query_root_path = api_client.QueryParameter(
    name="rootPath",
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PathNode']:
            return PathNode

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PathNode'], typing.List['PathNode']],
    ...
    def __getitem__(self, i: int) -> 'PathNode':
