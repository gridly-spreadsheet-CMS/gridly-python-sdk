...
# body param
SchemaForRequestBodyApplicationJson = UpdateTransMem


request_body_update_trans_mem = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TransMem
...
class BaseApi(api_client.Api):
    ...
    def _update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_trans_mem.serialize(body, content_type)
