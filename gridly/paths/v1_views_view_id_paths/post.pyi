...
# body param
SchemaForRequestBodyApplicationJson = CreatePath


request_body_create_path = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PathList
...
class BaseApi(api_client.Api):
    ...
    def _create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_path.serialize(body, content_type)
