...
# body param
SchemaForRequestBodyApplicationJson = DeletePath


request_body_delete_path = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _delete_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_delete_path.serialize(body, content_type)
