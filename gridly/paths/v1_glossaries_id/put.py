...
# body param
SchemaForRequestBodyApplicationJson = UpdateGlossary


request_body_update_glossary = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_glossary.serialize(body, content_type)
