...
# body param
SchemaForRequestBodyApplicationJson = CreateGlossary


request_body_create_glossary = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Glossary
...
class BaseApi(api_client.Api):
    ...
    def _create_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_glossary.serialize(body, content_type)
