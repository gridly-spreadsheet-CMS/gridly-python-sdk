...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'importRequest': typing.Union[ImportRequestSchema, None, str, ],
...
request_query_import_request = api_client.QueryParameter(
    name="importRequest",
