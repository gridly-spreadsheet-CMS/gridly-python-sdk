...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SetRecord']:
            return SetRecord

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['SetRecord'], typing.List['SetRecord']],
...
request_body_create_records = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_records.serialize(body, content_type)
