...
# body param
SchemaForRequestBodyApplicationJson = DeleteRecord


request_body_delete_record = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _delete_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_delete_record.serialize(body, content_type)
