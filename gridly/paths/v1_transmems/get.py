...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TransMem']:
            return TransMem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TransMem'], typing.List['TransMem']],
    ...
    def __getitem__(self, i: int) -> 'TransMem':
