...
# body param
SchemaForRequestBodyApplicationJson = CreateTransMem


request_body_create_trans_mem = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = TransMem
...
class BaseApi(api_client.Api):
    ...
    def _create_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_trans_mem.serialize(body, content_type)
