...
# body param
SchemaForRequestBodyApplicationJson = CreateColumn


request_body_create_column = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ViewColumn
...
class BaseApi(api_client.Api):
    ...
    def _create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_column.serialize(body, content_type)
