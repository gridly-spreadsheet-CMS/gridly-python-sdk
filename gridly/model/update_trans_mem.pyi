...
class UpdateTransMem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "projectIds", "fuzzyMatch", "isDisabled", "isPausedConsuming", "populateTranslationStatus", "contextLookup", "allowAlternative", "allowAlternativeHasSameRecordId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "projectIds", "fuzzyMatch", "isDisabled", "isPausedConsuming", "populateTranslationStatus", "contextLookup", "allowAlternative", "allowAlternativeHasSameRecordId", ], str]):
