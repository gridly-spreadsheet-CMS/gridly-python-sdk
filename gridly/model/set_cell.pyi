...
class SetCell(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["columnId", "dependencyStatus", "lengthLimit", "referencedIds", "sourceStatus", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["columnId", "dependencyStatus", "lengthLimit", "referencedIds", "sourceStatus", "value", ], str]):
