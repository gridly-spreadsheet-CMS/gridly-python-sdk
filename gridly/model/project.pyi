...
class Project(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "name", "description", "role", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "name", "description", "role", ], str]):
