...
class MergeCellConflict(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, column_id, option, *args, **kwargs):  # noqa: E501
        """MergeCellConflict - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, column_id, option, *args, **kwargs):  # noqa: E501
        """MergeCellConflict - a model defined in OpenAPI
