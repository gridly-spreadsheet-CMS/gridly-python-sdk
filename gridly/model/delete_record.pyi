...
class DeleteRecord(
        ...
        class properties:
            ...
            class identifiers(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RecordIdentifierWrapper']:
                        return RecordIdentifierWrapper
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['RecordIdentifierWrapper'], typing.List['RecordIdentifierWrapper']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'identifiers':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'RecordIdentifierWrapper':
                    return super().__getitem__(i)
            __annotations__ = {
                "ids": ids,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ids", "identifiers", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ids", "identifiers", ], str]):
