...
class AddViewColumn(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "editable", "name", "description", "type", "languageCode", "localizationType", "numberFormat", "selectionOptions", "reference", "formula", "dateTimeFormat", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "editable", "name", "description", "type", "languageCode", "localizationType", "numberFormat", "selectionOptions", "reference", "formula", "dateTimeFormat", ], str]):
