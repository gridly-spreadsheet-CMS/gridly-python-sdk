...
class Record(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class cells(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Cell'], typing.List['Cell']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "cells", "lastModifiedBy", "lastModifiedTime", "path", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "cells", "lastModifiedBy", "lastModifiedTime", "path", ], str]):
