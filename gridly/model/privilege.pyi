...
class Privilege(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "label", "level", "order", "serviceId", "description", "extra", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "label", "level", "order", "serviceId", "description", "extra", ], str]):
