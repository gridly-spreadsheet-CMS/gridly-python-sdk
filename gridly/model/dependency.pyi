...
class Dependency(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceColumnId", "targetColumnId", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceColumnId", "targetColumnId", "id", ], str]):
