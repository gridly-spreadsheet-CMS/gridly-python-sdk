...
class Group(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "groupId", "companyId", "name", "logoUrl", "type", "shareType", "createdDate", "lastModifiedDate", "systemGroup", "isSystemGroup", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "groupId", "companyId", "name", "logoUrl", "type", "shareType", "createdDate", "lastModifiedDate", "systemGroup", "isSystemGroup", ], str]):
