...
class CreateColumn(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "type", "id", "description", "editable", "languageCode", "localizationType", "numberFormat", "selectionOptions", "reference", "formula", "dateTimeFormat", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "type", "id", "description", "editable", "languageCode", "localizationType", "numberFormat", "selectionOptions", "reference", "formula", "dateTimeFormat", ], str]):
